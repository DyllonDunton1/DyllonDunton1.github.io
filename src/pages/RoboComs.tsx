      ...
      <div className='mainScroller'>
        ...
        <div className='ImageBanner'>
            <div className='BannerPic'>
                <img src='/robocoms/robocoms.gif' className='img' alt='RoboComs operator interface demonstration'></img>
            </div>
            <div className='BannerPic'>
                <img src='/robocoms/com_motors.gif' className='img' alt='RoboComs motor communication demonstration'></img>
            </div>
        </div>
        ...
        <div className='ContentBanner'>
            <a href="https://www.instagram.com/blackbearrobotics/" className="tileBase">
                <div className="tileImgContainer">
                    <img src="/robocoms/bbr_bot_2025.jpeg" className="tileImg" alt="University of Maine Black Bear Robotics robot"></img>
                </div>
