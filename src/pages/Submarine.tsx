  ...
  return (
    <div className='top'>
      ...
      <div className='mainScroller'>
        ...
        <h1 className='title'>Submarine Capstone (Completed With <a style={{color:"cyan"}} href="https://www.linkedin.com/in/jacob-wildes-88923b246/">Jacob Wildes</a>)</h1>
        ...
        <p className='desc'>
            ...
            Jacob Wildes also completed his <a style={{color:"cyan"}} href='https://digitalcommons.library.umaine.edu/honors/862/'>Honor's thesis</a>, which is an extension of this project based on using the submarine to detect fish in Maine lakes for the purpose of recording population levels.
        ...
        <a className='desc' style={{color:"cyan"}} href="https://github.com/jacobcwildes/Submarine_Capstone">Find the source code for this project at our GitHub!</a>
